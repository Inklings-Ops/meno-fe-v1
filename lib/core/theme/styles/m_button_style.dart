...
import 'package:meno_fe_v1/core/theme/base_styles/base_button_style.dart';
...
class MButtonStyle extends ThemeExtension<MButtonStyle> {
  ...
  static ButtonStyle get baseButtonStyle {
    return ButtonStyle(
      ...
      fixedSize: MTheme.all(const Size.fromHeight(MDimensions.btnMedium)),
      padding: MTheme.all(MDimensions.btnMediumPadding),
