...
const factory UsersRecentBroadcastsState.initial() = UsersRecentBroadcastsInitial;
  const factory UsersRecentBroadcastsState.empty() = UsersRecentBroadcastsEmpty;
  const factory UsersRecentBroadcastsState.loading() = UsersRecentBroadcastsLoading;
  ...
  const factory UsersRecentBroadcastsState.failure(BroadcastException exception) =
