...
mixin _$BroadcastFormState {
  ...
  IBroadcastArtwork? get artwork => throw _privateConstructorUsedError;
  List<User>? get cohosts => throw _privateConstructorUsedError;
  bool get recordingEnabled => throw _privateConstructorUsedError;
  bool get showError => throw _privateConstructorUsedError;
  bool get loading => throw _privateConstructorUsedError;
  Option<Either<BroadcastException, Broadcast>> get option =>
...
abstract class $BroadcastFormStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      bool showError,
      bool loading,
      Option<Either<BroadcastException, Broadcast>> option});
}
    ...
    return _then(_value.copyWith(
      ...
      option: null == option
          ...
          : option // ignore: cast_nullable_to_non_nullable
              as Option<Either<BroadcastException, Broadcast>>,
    ) as $Val);
  }
}
...
class _$_BroadcastFormState implements _BroadcastFormState {
  ...
  @override
  final IBroadcastArtwork? artwork;
  final List<User>? _cohosts;
  @override
  List<User>? get cohosts {
  ...
  final bool loading;
  @override
  final Option<Either<BroadcastException, Broadcast>> option;

  @override
  String toString() {
    return 'BroadcastFormState(title: $title, description: $description, artwork: $artwork, cohosts: $cohosts, recordingEnabled: $recordingEnabled, showError: $showError, loading: $loading, option: $option)';
  }
...
abstract class _BroadcastFormState implements BroadcastFormState {
  factory _BroadcastFormState(
      {required final IBroadcastTitle title,
      final IBroadcastDescription? description,
      final IBroadcastArtwork? artwork,
      final List<User>? cohosts,
      required final bool recordingEnabled,
      required final bool showError,
      required final bool loading,
      required final Option<Either<BroadcastException, Broadcast>>
          option}) = _$_BroadcastFormState;
