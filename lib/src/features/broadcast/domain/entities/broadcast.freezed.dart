...
class _$_Broadcast implements _Broadcast {
  ...
  @override
  String toString() {
    return 'Broadcast(id: $id, title: $title, description: $description, broadcastToken: $broadcastToken, status: $status, creator: $creator, imageId: $imageId, imageUrl: $imageUrl, timeZone: $timeZone, startTime: $startTime, endTime: $endTime, createdAt: $createdAt, deleted: $deleted)';
  }
...
abstract class _Broadcast implements Broadcast {
  factory _Broadcast(
      ...
      final DateTime? endTime,
      final DateTime? createdAt,
      final dynamic deleted}) = _$_Broadcast;
