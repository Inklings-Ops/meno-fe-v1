...
/// [DownloaderService] is used to control the download process.
/// It handles the initialization, registering [SendPort], enqueue the download task,
/// pause, resume and cancel the download task, track the status of the task, etc.
class DownloaderService {
  ...
  /// [initDownloaderService] method will initialize the downloader controller and perform certain operations like registering the port, initializing the register callback etc.
  static initDownloaderService() {
    log('DownloaderService - initDownloaderService called');
    _bindBackgroundIsolate();
  }

  /// [disposeDownloadService] is used to unbind the isolates and dispose the controller
  static disposeDownloadService() {
  ...
  static _bindBackgroundIsolate() {
    log('DownloaderService - _bindBackgroundIsolate called');
  ...
  static void _unbindBackgroundIsolate() {
    log('DownloaderService - _unbindBackgroundIsolate called');
  ...
  static _registerCallback(String id, int status, int progress) {
    log('DownloaderService - _registerCallback - task id = $id, status = $status, progress = $progress');
