...
import '../features/auth/application/account/account_cubit.dart' as _i57;
import '../features/auth/application/application.dart' as _i70;
import '../features/auth/application/auth/auth_bloc.dart' as _i58;
...
import '../features/broadcast/application/recently_live/recently_live_cubit.dart'
    as _i52;
import '../features/broadcast/application/stream/stream_bloc.dart' as _i56;
...
import '../features/broadcast/infrastructure/mapper/broadcast_mapper.dart'
    as _i7;
import '../features/chat/application/chat_bloc.dart' as _i61;
...
import '../features/notes/domain/domain.dart' as _i62;
import '../features/notes/infrastructure/datasources/datasources.dart' as _i64;
...
import '../features/notes/infrastructure/datasources/note_remote_datasource.dart'
    as _i19;
import '../features/notes/infrastructure/note_facade.dart' as _i63;
...
import '../features/profile/application/profile_form/profile_form_cubit.dart'
    as _i75;
import '../features/profile/domain/domain.dart' as _i65;
...
import '../features/profile/infrastructure/profile_facade.dart' as _i66;
import '../features/profile/profile.dart' as _i72;
import '../router/m_router.dart' as _i69;
...
import '../services/socket/socket_service.dart' as _i55;
import 'register_module.dart' as _i76;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    await gh.factoryAsync<_i55.SocketService>(
      () {
        final i = _i55.SocketService(facade: gh<_i31.IAuthFacade>());
        return i.initialize().then((_) => i);
      },
      preResolve: true,
    );
    gh.lazySingleton<_i56.StreamBloc>(() => _i56.StreamBloc(
          facade: gh<_i36.IBroadcastFacade>(),
          liveKit: gh<_i15.LiveKitService>(),
          socket: gh<_i55.SocketService>(),
          menoBloc: gh<_i17.MenoBloc>(),
          timer: gh<_i28.TimerCubit>(),
        ));
    gh.factory<_i57.AccountCubit>(
        () => _i57.AccountCubit(facade: gh<_i31.IAuthFacade>()));
    gh.lazySingleton<_i58.AuthBloc>(() => _i58.AuthBloc(
          facade: gh<_i31.IAuthFacade>(),
          onboardingFacade: gh<_i45.IOnboardingFacade>(),
        ));
    gh.lazySingleton<_i59.BroadcastBloc>(() => _i59.BroadcastBloc(
          facade: gh<_i36.IBroadcastFacade>(),
          liveKit: gh<_i15.LiveKitService>(),
          socket: gh<_i55.SocketService>(),
          menoBloc: gh<_i17.MenoBloc>(),
    ...
    gh.lazySingleton<_i60.BroadcastFormCubit>(() => _i60.BroadcastFormCubit(
          facade: gh<_i36.IBroadcastFacade>(),
          mediaService: gh<_i16.MediaService>(),
        ));
    gh.lazySingleton<_i61.ChatBloc>(() => _i61.ChatBloc(
          facade: gh<_i31.IAuthFacade>(),
          socket: gh<_i55.SocketService>(),
        )..init());
    gh.factory<_i62.INoteFacade>(() => _i63.NoteFacade(
          network: gh<_i18.NetworkService>(),
          local: gh<_i64.NoteLocalDatasource>(),
          remote: gh<_i64.NoteRemoteDatasource>(),
        ));
    gh.lazySingleton<_i65.IProfileFacade>(() => _i66.ProfileFacade(
          remote: gh<_i25.ProfileRemoteDatasource>(),
          local: gh<_i51.ProfileLocalDatasource>(),
          network: gh<_i18.NetworkService>(),
        ));
    gh.lazySingleton<_i67.LiveBroadcastsBloc>(
        () => _i67.LiveBroadcastsBloc(socket: gh<_i55.SocketService>()));
    gh.lazySingleton<_i68.LiveParticipantsBloc>(
        () => _i68.LiveParticipantsBloc(socket: gh<_i55.SocketService>()));
    gh.factory<_i69.MRouter>(() => _i69.MRouter(
          authBloc: gh<_i70.AuthBloc>(),
    ...
    gh.lazySingleton<_i73.NoteFormCubit>(
        () => _i73.NoteFormCubit(facade: gh<_i62.INoteFacade>()));
    gh.lazySingleton<_i74.NoteListBloc>(
        () => _i74.NoteListBloc(facade: gh<_i62.INoteFacade>()));
    gh.lazySingleton<_i75.ProfileFormCubit>(() => _i75.ProfileFormCubit(
          facade: gh<_i65.IProfileFacade>(),
