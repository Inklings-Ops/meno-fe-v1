...
class _$_RegisterState implements _RegisterState {
  ...
  @override
  String toString() {
    return 'RegisterState(fullName: $fullName, email: $email, password: $password, passwordValue: $passwordValue, showError: $showError, loading: $loading, option: $option, rememberMe: $rememberMe)';
  }
...
abstract class _RegisterState implements RegisterState {
  factory _RegisterState(
      ...
      required final bool rememberMe}) = _$_RegisterState;
