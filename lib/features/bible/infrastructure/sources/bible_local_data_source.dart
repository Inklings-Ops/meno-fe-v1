...
class BibleLocalDataSource with MLogger {
  BibleLocalDataSource({required Database db}) : _db = db;
  ...
  Future<void> seedFromAsset({
    ...
    log.d('BibleLocalDataSource: seeding from asset=$assetPath');
    ...
    log.d('BibleLocalDataSource: parsed ${verses.length} verses — writing...');
    ...
    log.d('BibleLocalDataSource: seed complete');
  }
  ...
  void _seedTranslations() {
    ...
    log.d('BibleLocalDataSource: seeded ${dtos.length} translations');
  }
