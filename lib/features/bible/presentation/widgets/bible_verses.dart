...
class BibleVerses extends WatchingWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        ListView.separated(
          padding: const EdgeInsets.only(bottom: 88), // room for action bar
...
class _SelectionActionBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // These are read synchronously — not reactive — because the action bar
    // is only visible when selectedVerses is non-empty.
