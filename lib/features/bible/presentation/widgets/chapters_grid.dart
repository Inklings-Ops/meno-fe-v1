...
class ChaptersGrid extends WatchingWidget {
  ...
  /// Invoked after the user taps a chapter — lets the parent modal
  /// re-scroll to keep the expanded book in view.
  ...
  Widget build(BuildContext context) {
    ...
    // Watch chapter so the selected highlight updates reactively.
