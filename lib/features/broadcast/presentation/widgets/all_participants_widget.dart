...
class AllParticipantsWidget extends StatelessWidget {
  ...
  String _getPluralText(int count) {
    return count == 1 ? '$count person tuned in!' : '$count people tuned in!';
  }
}
...
class _AvatarStack extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Calculate how many avatars to show (max 3)
      ...
      child: Stack(
        ...
        children: [
          ...
          ...List.generate(displayCount, (index) {
            ...
            return Positioned(
              left: index * 24.0, // 24px offset for each avatar
              child: _Avatar(imageUrl: participant.imageUrl, size: 40),
            );
          }),
