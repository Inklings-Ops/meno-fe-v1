...
import 'package:meno/features/chat/domain/entities/message.dart';
import 'package:meno/features/chat/infrastructure/dtos/message_sender_dto.dart';
...
final class MessageDto with EquatableMixin {
  ...
  factory MessageDto.fromJson(dynamic json) {
    if (json is! Map<String, dynamic>) {
      throw const FormatException('Invalid JSON type');
    }
