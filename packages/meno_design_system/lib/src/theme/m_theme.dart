...
class MTheme {
  ...
  static ThemeData _raw(Brightness brightness) {
    ...
    return ThemeData(
      ...
      iconTheme: IconThemeData(color: colorScheme.onBackground, size: 24.sp),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        contentPadding: const EdgeInsets.symmetric(horizontal: Insets.md).r,
      ),
      ...
      navigationBarTheme: NavigationBarThemeData(
        ...
        iconTheme: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return IconThemeData(size: 20.sp, color: colorScheme.primary);
          }
          return IconThemeData(size: 20.sp, color: colorScheme.inActive);
        }),
        labelTextStyle: WidgetStateTextStyle.resolveWith((states) {
          final style = textTheme.microMedium.sp;
          if (states.contains(WidgetState.selected)) {
      ...
      navigationRailTheme: NavigationRailThemeData(
        ...
        selectedLabelTextStyle: textTheme.microMedium
            .copyWith(color: colorScheme.primary)
            .sp,
        unselectedLabelTextStyle: textTheme.microMedium
            .copyWith(color: colorScheme.inActive)
            .sp,
      ),
      extensions: [
        colorScheme,
