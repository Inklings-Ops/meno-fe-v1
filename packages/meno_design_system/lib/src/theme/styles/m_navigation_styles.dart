  ...
  factory MNavigationStyles.$default(
    ...
    return MNavigationStyles(
      appBarTheme: AppBarTheme(
        ...
        toolbarHeight: 56.h,
        titleTextStyle: textTheme.bodyMedium.sp,
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        selectedIconTheme: IconThemeData(color: colors.primary, size: 20.sp),
        unselectedIconTheme: IconThemeData(color: colors.inActive, size: 20.sp),
        unselectedLabelStyle: textTheme.microMedium
            .copyWith(color: colors.inActive)
            .sp,
        selectedLabelStyle: textTheme.microMedium
            .copyWith(color: colors.primary)
            .sp,
      ),
      accentColor: MColor.secondary300,
      actionTextStyle: textTheme.captionMedium.sp,
      tabBarTheme: TabBarThemeData(
        labelStyle: textTheme.captionMedium.sp,
        labelColor: colors.primary,
        labelPadding: const EdgeInsets.symmetric(horizontal: Insets.sm).r,
        unselectedLabelStyle: textTheme.captionMedium.sp,
