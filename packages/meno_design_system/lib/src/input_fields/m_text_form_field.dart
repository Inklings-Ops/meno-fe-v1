...
class _MTextFormFieldState extends State<MTextFormField> {
  ...
  Widget build(BuildContext context) {
    ...
    return ConstrainedBox(
      constraints: const BoxConstraints(maxHeight: 100).r,
      child: LayoutBuilder(
  ...
  TextFormField _buildTextFormField(
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints: BoxConstraints.tight(const Size(44, 48)).r,
        prefixIcon: prefixWidget,
        suffixIconConstraints: BoxConstraints.tight(const Size(44, 48)).r,
...
class _EyeIcon extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final iconSize = Insets.xl.sp;
    return Container(
      height: iconSize,
      width: iconSize,
      margin: const EdgeInsets.only(right: Insets.md).r,
      child: obscureText
