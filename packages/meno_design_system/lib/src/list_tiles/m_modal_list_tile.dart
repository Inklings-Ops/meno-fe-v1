...
class MModalListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      height: showDivider ? 56.0.h : null,
      child: Column(
        children: [
          ListTile(
            onTap: onTap,
            ...
            contentPadding:
                contentPadding?.r ?? const EdgeInsets.fromLTRB(12, 0, 12, 0).r,
          ),
          if (showDivider)
            const MDivider(bottomSpace: Insets.sm, topSpace: Insets.sm),
        ],
      ),
    );
  }
